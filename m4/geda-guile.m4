...
# Removing hardcoded guile package numbers from the macro tambotitree@gmail.com Ref Issue 1
...
#                          [GUILE_PKG_NAME=guile-2.2], [_found_pkg_config_guile=no])
  ...
  _found_pkg_config_guile=yes
  PKG_CHECK_MODULES(GUILE, [$GUILE_PKG_NAME >= $GUILE_MIN_VER],
                           [GUILE_PKG_NAME=guile], [_found_pkg_config_guile=no])
